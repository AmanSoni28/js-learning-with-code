...
const balance = new Number(400);                     //*now this is 100% sure 400 is number,   write down on google console and knows all the "Number" method(function) and properties, new keyword use to creat an abject, here Number type of object is created 
console.log(balance);
